...
#         self.action_space = spaces.Box(self.action_low, self.action_high, dtype = np.float16)
    ...
    def step(self, action):
        ...
        is_obstacle_a, velocity_surge_a, velocity_yaw_a, target_distance_a, target_radian_a, ahead_radian_a, done_a, _, _, _, _, _, _, _, _, _, _, _,\
        is_obstacle_b, velocity_surge_b, velocity_yaw_b, target_distance_b, target_radian_b, ahead_radian_b, done_b, _, _, _, _, _, _, _, _, _, _, _ = self.state # 获取agent位置，速度，目标位置
