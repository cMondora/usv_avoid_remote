...
class AvoidWorldEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.list_acc_yaw = np.linspace(-0.5, 0.5, 9)
...
#         elif acc_yaw >= 0.35 and acc_yaw < 0.45: acc_yaw = 0.4
    ...
    def reset(self):
        ...
        # # ------------- define reset target and usv
        self.usv_x, self.usv_y = 15.0, 15.0
        self.target_x, self.target_y = 65.0, 35.0
        # # ------------- define reset target and usv
        self.t = 0
        self.control_out = 0
