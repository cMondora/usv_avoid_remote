...
OBSTACLE_POS = [[24.5, 13.5], [26.4, 41.3], [9.5, 17.3], [42.2, 39.5], [12.4, 34.3]]
OBSTACLE_RADIUS = [2.5, 2.5, 2.5, 2.5, 2.5]
# DECRIE = 8e-3
...
class AvoidWorldEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.usv_x_a = 15.0
        self.usv_y_a = 15.0
        self.target_x_a = 45.0
        self.target_y_a = 45.0

        self.usv_x_b = 15.0
        self.usv_y_b = 45.0
        self.target_x_b = 15.0
        self.target_y_b = 45.0
