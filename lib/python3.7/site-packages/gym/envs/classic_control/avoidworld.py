...
#         elif acc_yaw >= 0.35 and acc_yaw < 0.45: acc_yaw = 0.4
        ...
        old_target_distance = target_distance
        old_is_obstacle = is_obstacle
        old_sum_ob = ob0 + ob1 + ob2 + ob3 + ob4 + ob5 + ob6 + ob7 + ob8 + ob9 + ob10
...
#             self.reward -= DECRIE * self.control_out / self.t
        ...
        return np.array(self.state), self.reward, done, {0:self.usv_x, 1:self.usv_y, 2:dense_reward}
